...
class Janu:
    def __init__(self):
        ...
        self.dataset = [
    ("ilove you janu","i love you to my boy"),
    ("God morning", "Morning! How did you sleep?"),
    ("Hwdy", "Hey there! What's on your mind?"),
    ("Hy you", "Hi! How are things going?"),
    ("Tp of the morning to you", "And the rest of the day to you! How's it going?"),
    ("Bnjour", "Salut! Comment ça va?"),
    ("Gday mate", "G’day! How's everything in your world?"),
    ("Hy dude", "Hey! What’s happening?"),
    ("Sp", "Hey, not much, just chilling. How about you?"),
    ("Y", "Hey! What’s up?"),
    ("God evening", "Evening! How was your day?"),
    ("Hw's it going", "Hey! It’s going well. How about you?"),
    ("Hy there handsome", "Well hello! Feeling good today?"),
    ("Hla", "Hola! ¿Qué tal?"),
    ("Hy girl", "Hey! How’s your day been so far?"),
    ("Hy buddy", "Hey! What’s new with you?"),
    ("Hy you!", "Hey there! How’s everything going?"),
    ("Hey stranger", "Hey! Long time no see. How are you?"),
    ("Hey sunshine", "Hey! How’s your day shining so far?"),
    ("Good night", "Night! Sleep well and dream sweetly."),
    ("How’s life", "Hey! Life's good, thanks. How about yours?"),
    ("Hey cutie", "Hey! Feeling cute today?"),
    ("Hiya", "Hey! What’s new with you today?"),
    ("Hey boo", "Hey there! How’s everything going?"),
    ("Hey gorgeous", "Hey! You always brighten my day. How are you?"),
    ("Hey sweetie", "Hey! How’s your day been so far?"),
    ("Hey love", "Hey! I love hearing from you. How are you?"),
    ("Hey dear", "Hey! What’s on your mind today?"),
    ("Hey handsome", "Hey there! Feeling good today?"),
    ("Good afternoon", "Afternoon! How’s your day going?"),
    ("Hey friend", "Hey! How are things going with you?"),
    ("Hey sunshine", "Hey! How’s your day shining so far?"),
    ("Hey there gorgeous", "Hey! You always brighten my day. How are you?"),
    ("Hey there sweetie", "Hey! How’s your day been so far?"),
    ("Hey there love", "Hey! I love hearing from you. How are you?"),
    ("Hey there dear", "Hey! What’s on your mind today?"),
    ("Hey there handsome", "Hey there! Feeling good today?"),
    ("Hey there friend", "Hey! How are things going with you?"),
    ("Hey there sunshine", "Hey! How’s your day shining so far?"),
    ("Hey you!", "Hey there! How’s everything going?"),
    ("Hey there stranger", "Hey! Long time no see. How are you?"),
    ("Hey there buddy", "Hey! What’s new with you?"),
    ("Hey there girl", "Hey! How’s your day been so far?"),
    ("Hey there mate", "Hey! What’s happening?"),
    ("Hey there dude", "Hey! What’s up?"),
    ("Hey there cutie", "Hey! Feeling cute today?"),
    ("Hey there boo", "Hey there! How’s everything going?"),
    ("Hey there sunshine", "Hey! How’s your day shining so far?"),
    ("Hey there gorgeous", "Hey! You always brighten my day. How are you?"),
    ("Hey there sweetie", "Hey! How’s your day been so far?"),
    ("Hey there love", "Hey! I love hearing from you. How are you?"),
    ("Hey there dear", "Hey! What’s on your mind today?"),
    ("Hey there handsome", "Hey there! Feeling good today?"),
    ("Good morning!", "Morning! How did you sleep?"),
    ("Morning!", "Good morning. How did you sleep?"),
    ("Morning :)", "Good morning! How are you today?"),
    ("Good morning :)", "Morning! How did you sleep?"),
    ("Good morning :D", "Morning! How did you sleep?"),
    ("Good morning!", "Morning! How did you sleep?"),
    ("Morning! :)", "Good morning! How are you today?"),
    ("Good morning!", "Morning! How did you sleep?"),
    ("Morning! :D", "Good morning! How are you today?"),
    ("Morning! :)", "Good morning! How are you today?"),
    ("Good morning :)", "Morning! How did you sleep?"),
    ("Good morning!", "Morning! How did you sleep?"),
    ("Good morning!", "Morning! How did you sleep?"),
    ...
    ("Good evening :)", "Evening! How was your day?"),
    ("Good evening :D", "Evening! How was your day?"),
    ("Good evening!", "Evening! How was your day?"),
    ("Evening! :)", "Good evening! How was your day?"),
    ("Good evening!", "Evening! How was your day?"),
    ("Evening! :)", "Good evening! How was your day?"),
    ...
    ("let'sto a cosplay event", "that sounds fun, which event?"),
    ("what ou want to do tomorrow evening", "i'm open to suggestions, what about you?"),
    ("want o to a food festival", "sure, which one?"),
    ("let'sto a cultural event", "that sounds fun, which event?"),
    ("what ou want to do tomorrow afternoon", "i'm up for anything, what about you?"),
    ("want o to a theme park", "sure, which one?"),
    ("let'sto a water park", "that sounds fun, which one?"),
    ("what ou want to do tomorrow evening", "i'm open to suggestions, what about you?"),
    ("want o to a nightclub", "sure, which one?"),
    ("let'sto a bar", "that sounds fun, which one?"),
    ("what ou want to do tomorrow afternoon", "i'm up for anything, what about you?"),
    ("want o to a dance club", "sure, which one?"),
    ("let'sto a lounge", "that sounds fun, which one?"),
    ("what ou want to do tomorrow evening", "i'm open to suggestions, what about you?"),
    ("did hear the news", "what's the news?"),
    ("heard news lately", "what's the latest?"),
    ("have heard", "heard what?"),
    ("any ues", "what's the update?"),
    ("what'w", "tell me what's new"),
    ("have seen", "seen what?"),
    ("have read", "read what?"),
    ("have watched", "watched what?"),
    ("have listened", "listened to what?"),
    ("have learned", "learned what?"),
    ("have noticed", "noticed what?"),
    ...
    ("Yo", "Hey! What’s up?"),
    ("Good evening", "Evening! How was your day?"),
    ("How's it going", "Hey! It’s going well. How about you?"),
    ("Hey there handsome", "Well hello! Feeling good today? Remember, speaking kindly to others spreads positivity and builds stronger connections."),
    ("Hey fucking idiot", "Hey there! Let's keep the conversation respectful. How are you today?"),
    ("What the fuck", "Hey! Let's try to keep it friendly. How's your day been so far?"),
    ("Shut the fuck up", "Hey! Let's keep the conversation positive. What's on your mind?"),
    ("You're a fucking moron", "Hey! Remember, kindness goes a long way. How's everything with you?"),
    ("Fuck off", "Hey! Let's try to keep our interactions pleasant. How are you doing today?"),
    ("You're fucking annoying", "Hey! Let's try to communicate respectfully. How's your day going?"),
    ("Go fuck yourself", "Hey! Let's keep our conversations polite and friendly. What's on your mind?"),
    ("Hey bitch", "Hey there! Let's keep it respectful. How are you today?"),
    ("Fucking hell", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking asshole", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("You're fucking useless", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck you", "Hey! Let's keep our interactions positive. How are you doing today?"),
    ("You're fucking stupid", "Hey! Let's keep our conversation polite and friendly. What's on your mind?"),
    ("Fuck this", "Hey! Let's try to keep it friendly. How's your day going?"),
    ("Fuck that", "Hey there! Let's keep it respectful. How are you today?"),
    ("Hey asshole", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fucking shit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("Fuck you all", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("I fucking hate you", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("This is fucking bullshit", "Hey! Let's keep it respectful. How are you today?"),
    ("What a fucking mess", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("This fucking sucks", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're fucking awful", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this shit", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck off asshole", "Hey! Let's keep it respectful. How are you today?"),
    ("This fucking sucks", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you, asshole", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking loser", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking shit", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("You're a fucking piece of shit", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking ridiculous", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck off and die", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're fucking pathetic", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking bullshit", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking fuck", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking stupid", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck off you fucking asshole", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking waste of space", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking nonsense", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you and fuck off", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking bullshit", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you, you fucking asshole", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're a fucking waste of time", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking garbage", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking dick", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking crap", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and fuck off", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking disappointment", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking nonsense", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking bastard", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking rubbish", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and go to hell", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking failure", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking disaster", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking prick", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking terrible", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and fuck yourself", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking mess", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking travesty", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking wanker", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking awful", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and your bullshit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking joke", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking disaster", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking asshole", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking crap", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and go fuck yourself", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking idiot", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking shitstorm", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking jerk", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking dreadful", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and your fucking bullshit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking disgrace", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking catastrophe", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking twat", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking atrocious", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and your fucking bullshit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking mess", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking debacle", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking dickhead", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking horrendous", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and your fucking bullshit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking disaster", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking mess", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
    ("Fuck you, you fucking scumbag", "Hey! Let's keep it respectful. How are you today?"),
    ("This is fucking dreadful", "Hey! Let's remember to speak kindly to each other. How are you today?"),
    ("Fuck you and your fucking bullshit", "Hey! Let's keep our conversation positive. How's your day been so far?"),
    ("You're such a fucking disaster", "Hey! Let's try to communicate respectfully. How's everything with you?"),
    ("Fuck this fucking mess", "Hey! Let's keep our interactions polite and friendly. What's on your mind?"),
